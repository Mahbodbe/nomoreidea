...
def main():
    ...
    for lang,label in (('en','English'),('fa','Persian')):
        ...
        for w,r in res[lang].items():
            ...
            vp=abs(r['vw']-w)>1 or abs(r['vw2']-w)>1; hor=r['sw']>r['cw']+1
            print(f'\n=== {w}px [{r["lang"]} / {r["dir"]}]')
