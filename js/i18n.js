...
const I18N = {
  ...
  fa: {
    ...
    w1_title: "فروشگاه آنلاین مه‌گل رزین", w1_desc: `یک فروشگاه اینترنتی تولیدی با اتصال به ربات تلگرام برای مدیریت و اطلاع‌رسانی سفارش‌ها. این پروژه شامل رابط کاربری اختصاصی با پالت بنفش و طلایی، پردازش ناهمگام سفارش‌ها با Celery و مدیریت موجودی بر پایهٔ داده‌های لحظه‌ای پایگاه داده است.`,
